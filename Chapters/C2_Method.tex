...
\begin{itemize}
    ...
    \item Speed: \steel is much faster than most models as is the design specification, however, the choice of \textsc{python} as the language has had certain drawbacks. Iterative processes are slow, for this reason, the entire star formation module was written in \textsc{cython} a type defined version of python that is pre-compiled into \textsc{c}, this process is both slow and difficult. With a full refactor the choice of language and acceleration tools could be more carefully considered with the end goals better defined.
