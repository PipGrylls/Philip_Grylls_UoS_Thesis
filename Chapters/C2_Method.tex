...
\begin{itemize}
    \item scatter specifically up-scatter
    \item key zones (knee)
    \item high mass slope dictates very little of the SMF
\end{itemize}
