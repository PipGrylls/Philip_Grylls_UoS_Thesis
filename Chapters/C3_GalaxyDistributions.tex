...
The quality of data presented in Figure \ref{fig:Sat_Dist_High_z}, SDSS and targeted cluster observations, is a limitation to our ability to constrain the environments of galaxies over many epochs. The data limits the technique due to the lack of halo mass estimations and satellite/central identification in the high redshift data sets. To obtain the required data products accurate clustering analysis simmilar to that of \citet{Yang2012EvolutionHalos} must be applied to comprehensive high redshift surveys such as EUCLID. 
