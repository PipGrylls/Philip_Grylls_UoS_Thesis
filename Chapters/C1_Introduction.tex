...
In this chapter we compare several different modelling techniques and discuss specific examples in terms of volume, resolution and number of modelling parameters. In Table \ref{tab:ModelComp} we quantitatively show the differences between \steel \cite{Grylls2019AClusters, Grylls2020PredictingSTEEL, Grylls2020TheFractions}, \citet{Rodriguez-Puebla2017ConstrainingProperties}, U\textsc{niverse} M\textsc{achine} \cite{Behroozi2019UniverseMachine:010}, \citet{Somerville2008ANuclei}, and TNG \cite{Nelson2019TheRelease}. As described in the prior sections of this Chapter each `flavour' of galaxy model uses/interprets volume, resolution, and modelling parameters differently. So in many cases the direct comparisons between quantitative descriptors must be caveated by considering the models in question. 
...
$\steel$ & Statistical SEM & N/A (Statistical)  & Arbitrary & 15-30 (1-5) (14-29) \\
R-P+2017 & SEM & 250 - 1000 $h^{-1}$ & $9.6 \times 10^7$ - $8.7 \times 10^9$ & 18 (18) (0)\\
UniM & SEM & 250 $h^{-1}$ & $1.6\times10^8h^{-1}$ & 46 (44) (2) \\
Somerville+08 & SAM & N/A (Press Shecter e.g. \citet{Parkinson2008GeneratingTrees}) & $10^{10}$ ($10^{11}$ smallest root) & \\
TNG (50, 100, 300) & Numerical  & 51.7, 110.7, 302.6 & $4.5\times10^5$, $7.5\times10^6$, $5.9\times 10^7$ & 39+A\textsc{pero} (39) (A\textsc{pero})       
\end{tabularx}
\caption{A summary of different codes in terms of method, volume, resolution and modelling parameters.}
\end{table}
