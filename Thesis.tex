...
Several popular techniques exist for cosmological modelling of galaxies, from computationally intensive `physical' hydrodynamical simulations, highly parameterised ab-initio semi-analytic models, to data-driven semi-empirical models. Each of these techniques has made valuable contributions to our understanding of galaxy evolution and the contributing effects of; dark matter, galaxy-galaxy mergers, star formation, feedback from supernovae and supermassive black holes, environmental stripping, morphological evolution, and much more.

However, each of the described models has some caveats that present significant drawbacks to the range of predictions they can make and the validity thereof. In the case of hydrodynamical, specifically their sub-grid physics, and semi-analytic models the high parametrisation can cause non-trivial degeneracies that prevent clear analysis of which processes are driving galaxy evolution. Furthermore, all aforementioned models must balance simulating a large universe against simulating galaxies with high fidelity. This trade-off between volume and resolution introduces a bias in the number of objects simulated at different masses given differences in cosmological abundances.

This thesis describes the STastical sEmi-Empirical model, $\steel$, and its contributions to the modelling of galaxies. \steel is built to overcome the limitations of volume and resolution. We remove these constraints and any associated biases using a novel technique, based on the halo mass function, to replace discrete haloes with a statistical alternative. This cutting edge statistical dark matter backbone is then combined with empirical techniques, e.g. Abundance Matching, to create $\steel$.

In this thesis we describe five applications of $\steel$: Recreating the distributions of satellite galaxies over a cosmic time frame; Predicting the in-situ and ex-situ growth of central galaxies using constrained group and cluster environments; Calculating a new continuity style star formation rate; Probing the systematic effects of the stellar-mass-halo-mass relation on the galaxy pair fraction; Testing proposed models for the evolution of galaxy morphological fractions using constrained merger histories.
...
In this thesis, we empirically generate using \steel the assembly histories of galaxies which are then constrained using SDSS, high redshift cluster observations. Using these constraints we probe the in-situ vs. ex-situ growth of galaxies. It is found that within \LCDM hierarchical assembly the stellar-mass-halo-mass relation created using certain stellar mass functions produces a satellite accretion history that is inconsistent with the central galaxy growth. \steel is able to identify this unique result due to both its statistical and empirical nature.
