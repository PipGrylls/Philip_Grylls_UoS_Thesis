...
In this thesis, we empirically generate using \steel the assembly histories of galaxies which are then constrained using SDSS, high redshift cluster observations. Using these constraints we probe the in-situ vs. ex-situ growth of galaxies. It is found that within \LCDM hierarchical assembly using certain stellar mass functions produces a satellite accretion history that is inconsistent with the central galaxy growth.

Furthermore, there is a noted tension in the observed galaxy pair fraction and its evolution with redshift. We use the flexible nature of  \steel we present a systematic investigation into how stellar mass function derivations affect the pair fraction. It is found that the pair fraction can be substantially altered these choices providing an avenue to remove the discrepancies in pair fraction observations.

Finally, there is still an active debate over the significance of mergers on the morphological evolution. We find that mergers are capable of creating the observed elliptical fractions, and additionally, a two pathway merger and in-situ disk instability can produce the observed lenticular fractions.
